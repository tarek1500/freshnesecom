		...
		if (this.rtl) {
			this.shippingPolicy = {
				...
				tableOfContents: [
					{
						name: '',
						content: '<p>سياسة الشحن والتسليم هذه جزء من الأحكام والشروط الخاصة بنا ("الشروط") وبالتالي يجب قراءتها جنبًا إلى جنب مع الشروط الرئيسية لدينا: <a href="https://freshnesecom-template.herokuapp.com/terms-and-conditions">الأحكام والشروط</a>.</p><p>يرجى مراجعة سياسة الشحن والتوصيل بعناية عند شراء منتجاتنا. ستطبق هذه السياسة على أي طلب تقدمه معنا.</p>'
					},
					{
